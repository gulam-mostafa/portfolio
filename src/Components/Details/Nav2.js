...
const Nav = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <li><Link activeClass="active" to="/" spy={true} smooth={true} offset={50} duration={800} >Home</Link></li>
    ...
    <Link to='/' className="btn btn-ghost normal-case text-2xl">Md Gulam Mostafa</Link>
  </div>
  ...
  {/* <div className="navbar-end">
    <Link activeClass="active" to="contact" spy={true} smooth={true} offset={50} duration={2800} className="hidden md:block">blog</Link>
  </div> */}
</div>
        </div>
    );
